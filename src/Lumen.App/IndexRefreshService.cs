...
public sealed class IndexRefreshService(IApplicationDiscoveryService discovery, IMsixApplicationDiscoveryService msixDiscovery, IPortableScanner portableScanner, IApplicationStore store, ILogger<IndexRefreshService> logger)
{
